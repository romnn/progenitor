...
mod tests {
    ...
    conformance_support::assert_display!(types::ChoiceFinishReason, types::ChatMessageRole);
    conformance_support::assert_from_str!(types::ChoiceFinishReason, types::ChatMessageRole);
