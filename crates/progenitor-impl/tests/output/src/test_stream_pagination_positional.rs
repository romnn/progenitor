...
pub mod types {
    ...
    impl<'de> self::de::Build<'de> for Uint32ResultsPage {
        const NAME: &'static str = "Uint32ResultsPage";
    ...
    impl<'de> ::serde::Deserialize<'de> for Uint32ResultsPage {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::Deserializer<'de>,
        {
    ...
    impl ::serde::Serialize for Uint32ResultsPage {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::Serializer,
        {
            ...
            let mut state =
                ::serde::Serializer::serialize_struct(serializer, "Uint32ResultsPage", len)?;
