...
pub mod types {
    ...
    impl<'de> self::de::Build<'de> for CreateThing {
    ...
    impl<'de> ::serde::Deserialize<'de> for CreateThing {
    ...
    impl ::serde::Serialize for CreateThing {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::Serializer,
        {
            let len = 0usize + 1;
            let mut state = ::serde::Serializer::serialize_struct(serializer, "CreateThing", len)?;
    ...
    impl<'de> self::de::Build<'de> for Dog {
        const NAME: &'static str = "Dog";
        const FIELDS: &'static [&'static str] = &["bark", "petType"];
        fn build<E>(mut fields: self::de::Fields<'de>) -> ::std::result::Result<Self, E>
        where
            E: ::serde::de::Error,
        {
            let value = Self {
                bark: self::de::defaulted(&mut fields, "bark")?,
                pet_type: self::de::required(&mut fields, "petType")?,
            };
            ::std::result::Result::Ok(value)
        }
    }

    impl<'de> ::serde::Deserialize<'de> for Dog {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::Deserializer<'de>,
        {
    ...
    impl ::serde::Serialize for Dog {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::Serializer,
        {
            let len = 0usize
                + ::std::primitive::usize::from(!::std::option::Option::is_none(&self.bark))
                + 1;
            let mut state = ::serde::Serializer::serialize_struct(serializer, "Dog", len)?;
            if !::std::option::Option::is_none(&self.bark) {
                ::serde::ser::SerializeStruct::serialize_field(&mut state, "bark", &self.bark)?;
            }
            ::serde::ser::SerializeStruct::serialize_field(&mut state, "petType", &self.pet_type)?;
            ::serde::ser::SerializeStruct::end(state)
        }
    }
    ...
    impl self::de::UnitEnum for DogPetType {
        const NAME: &'static str = "DogPetType";
        const VARIANTS: &'static [&'static str] = &["Dog"];
        fn from_index(index: usize) -> Self {
            match index {
                0usize => Self::Dog,
    ...
    impl<'de> ::serde::Deserialize<'de> for DogPetType {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::Deserializer<'de>,
        {
    ...
    impl<'de> self::de::Build<'de> for Label {
        ...
        {
            let value = Self {
                text: self::de::required(&mut fields, "text")?,
            };
            ::std::result::Result::Ok(value)
        }
    }
    ...
    impl ::serde::Serialize for Label {
        ...
        {
            let len = 0usize + 1;
            let mut state = ::serde::Serializer::serialize_struct(serializer, "Label", len)?;
            ::serde::ser::SerializeStruct::serialize_field(&mut state, "text", &self.text)?;
            ::serde::ser::SerializeStruct::end(state)
        }
    }
    ...
    impl<'de> self::de::Build<'de> for Thing {
        const NAME: &'static str = "Thing";
        const FIELDS: &'static [&'static str] =
            &["count", "either", "id", "kind", "labels", "note", "weight"];
        fn build<E>(mut fields: self::de::Fields<'de>) -> ::std::result::Result<Self, E>
        where
            E: ::serde::de::Error,
        {
            let value = Self {
                count: self::de::defaulted(&mut fields, "count")?,
                either: self::de::defaulted(&mut fields, "either")?,
                id: self::de::required(&mut fields, "id")?,
                kind: self::de::required(&mut fields, "kind")?,
                labels: self::de::defaulted(&mut fields, "labels")?,
                note: self::de::defaulted(&mut fields, "note")?,
                weight: self::de::defaulted(&mut fields, "weight")?,
            };
            ::std::result::Result::Ok(value)
        }
    }
    ...
    impl ::serde::Serialize for Thing {
        ...
        {
            let len = 0usize
                + ::std::primitive::usize::from(!::std::option::Option::is_none(&self.count))
                + ::std::primitive::usize::from(!::std::option::Option::is_none(&self.either))
                + 1
                + 1
                + ::std::primitive::usize::from(!::std::vec::Vec::is_empty(&self.labels))
                + ::std::primitive::usize::from(!::std::option::Option::is_none(&self.note))
                + ::std::primitive::usize::from(!::std::option::Option::is_none(&self.weight));
            let mut state = ::serde::Serializer::serialize_struct(serializer, "Thing", len)?;
            if !::std::option::Option::is_none(&self.count) {
                ::serde::ser::SerializeStruct::serialize_field(&mut state, "count", &self.count)?;
            }
            if !::std::option::Option::is_none(&self.either) {
                ::serde::ser::SerializeStruct::serialize_field(&mut state, "either", &self.either)?;
            }
            ...
            if !::std::vec::Vec::is_empty(&self.labels) {
                ::serde::ser::SerializeStruct::serialize_field(&mut state, "labels", &self.labels)?;
            }
            if !::std::option::Option::is_none(&self.note) {
                ::serde::ser::SerializeStruct::serialize_field(&mut state, "note", &self.note)?;
            }
            if !::std::option::Option::is_none(&self.weight) {
    ...
    impl self::de::UnitEnum for ThingKind {
        const NAME: &'static str = "ThingKind";
        const VARIANTS: &'static [&'static str] = &["fixed"];
        fn from_index(index: usize) -> Self {
            match index {
                0usize => Self::Fixed,
                _ => unreachable!("variant index out of range"),
    ...
    impl<'de> ::serde::Deserialize<'de> for ThingKind {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::Deserializer<'de>,
        {
