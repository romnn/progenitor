...
pub mod types {
    ...
    impl<'de> self::de::Build<'de> for BodyWithDefaults {
        const NAME: &'static str = "BodyWithDefaults";
        const FIELDS: &'static [&'static str] = &["forty-two", "s", "something", "yes"];
        fn build<E>(mut fields: self::de::Fields<'de>) -> ::std::result::Result<Self, E>
        where
            E: ::serde::de::Error,
        {
            let value = Self {
                forty_two: self::de::defaulted_with(&mut fields, "forty-two", || {
                    defaults::default_u64::<u32, 42>()
                })?,
                s: self::de::required(&mut fields, "s")?,
                something: self::de::defaulted_with(&mut fields, "something", || {
                    defaults::body_with_defaults_something()
                })?,
                yes: self::de::defaulted(&mut fields, "yes")?,
            };
            ::std::result::Result::Ok(value)
        }
    }

    impl<'de> ::serde::Deserialize<'de> for BodyWithDefaults {
    ...
    impl ::serde::Serialize for BodyWithDefaults {
            ...
            S: ::serde::Serializer,
        {
            ...
            let mut state =
                ::serde::Serializer::serialize_struct(serializer, "BodyWithDefaults", len)?;
            ::serde::ser::SerializeStruct::serialize_field(
                &mut state,
                "forty-two",
                &self.forty_two,
            )?;
            ::serde::ser::SerializeStruct::serialize_field(&mut state, "s", &self.s)?;
            ::serde::ser::SerializeStruct::serialize_field(
                &mut state,
                "something",
                &self.something,
            )?;
            ::serde::ser::SerializeStruct::serialize_field(&mut state, "yes", &self.yes)?;
